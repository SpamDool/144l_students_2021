...
``` r
count.tab <- read_rds("C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Input_Data/week7/seqtab-nochimtaxa.rds") #table of counts for each sequence in each sample
tax.tab <- read_rds("C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Input_Data/week7/taxa.rds") #table that matches ASV to sequence
...
metadata_OG <- read_excel("C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Input_Data/week7/ACIDD_Exp_BactAbund.xlsx", sheet = "Metadata")
glimpse(metadata_OG)
```
...
``` r
metadata_doc <- read_rds("C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Input_Data/week7/ACIDD_Exp_Processed_DOC_BGE.rds")
...
A1: In the chunk above, we created a new phyloseq object (sub_ps) that
filters out sequences that correspond with chloroplasts and mitochondria
in our original phyloseq object ps. We did this because we are only
interested in the amplified bacterial sequences, not mitochondria and
chloroplasts. These organisms are not part of our study.
...
A2: “Sequencing depth” means how many read counts were made in each
sample sample during a read. It is how many total sequences were counted
in each sample.
...
A3: The subsampling we did here will not have a large effect on our beta
diversity because the mean of our read depth is similar before and after
subsampling (7695 vs 6047).
...
```
    ...
    ## Square root transformation
    ## Wisconsin double standardization
    ## Run 0 stress 0.04065185 
    ## Run 1 stress 0.1613282 
    ## Run 2 stress 0.04065185 
    ## ... New best solution
    ## ... Procrustes: rmse 7.997778e-06  max resid 1.60832e-05 
    ## ... Similar to previous best
    ## Run 3 stress 0.04065185 
    ## ... New best solution
    ## ... Procrustes: rmse 8.81248e-06  max resid 1.735082e-05 
    ## ... Similar to previous best
    ## Run 4 stress 0.303886 
    ## Run 5 stress 0.1613282 
    ## Run 6 stress 0.04065185 
    ## ... Procrustes: rmse 1.109856e-05  max resid 2.231015e-05 
    ## ... Similar to previous best
    ## Run 7 stress 0.04065186 
    ## ... Procrustes: rmse 1.482397e-05  max resid 3.010791e-05 
    ## ... Similar to previous best
    ## Run 8 stress 0.04065186 
    ## ... Procrustes: rmse 2.782049e-05  max resid 5.578809e-05 
    ## ... Similar to previous best
    ## Run 9 stress 0.04065185 
    ## ... New best solution
    ## ... Procrustes: rmse 4.315813e-06  max resid 8.439315e-06 
    ## ... Similar to previous best
    ## Run 10 stress 0.04065186 
    ## ... Procrustes: rmse 3.015591e-05  max resid 6.085642e-05 
    ## ... Similar to previous best
    ## Run 11 stress 0.04065187 
    ## ... Procrustes: rmse 3.801155e-05  max resid 7.813038e-05 
    ## ... Similar to previous best
    ## Run 12 stress 0.1763047 
    ## Run 13 stress 0.04065186 
    ## ... Procrustes: rmse 2.122768e-05  max resid 4.421356e-05 
    ## ... Similar to previous best
    ## Run 14 stress 0.04065186 
    ## ... Procrustes: rmse 1.957735e-05  max resid 3.865757e-05 
    ## ... Similar to previous best
    ## Run 15 stress 0.04065187 
    ## ... Procrustes: rmse 4.231653e-05  max resid 8.505289e-05 
    ## ... Similar to previous best
    ## Run 16 stress 0.04065185 
    ## ... Procrustes: rmse 3.579068e-06  max resid 6.713043e-06 
    ## ... Similar to previous best
    ## Run 17 stress 0.04065185 
    ## ... Procrustes: rmse 6.897888e-06  max resid 1.51315e-05 
    ## ... Similar to previous best
    ## Run 18 stress 0.04065185 
    ## ... Procrustes: rmse 5.624605e-06  max resid 1.288795e-05 
    ## ... Similar to previous best
    ## Run 19 stress 0.04065185 
    ## ... Procrustes: rmse 4.24661e-06  max resid 9.719898e-06 
    ## ... Similar to previous best
    ## Run 20 stress 0.04065186 
    ## ... Procrustes: rmse 1.19868e-05  max resid 2.556198e-05 
    ## ... Similar to previous best
    ## *** Solution reached
...
A4: The two NMDS plots were made using subsampled (standardized) and
non-subsampled datasets of NMDS ordinations of our full community
samples. As both showed very similar patterns, we will use the
standardized dataset because it does not seem to change diversity
patterns.
...
A5: In both the San Diego and Santa Barbara data, the graphs showed more
similarity between control and ash leachate at Day 0 than at the final
timepoint, where the both the control and ash leachate community were
relatively similar to other data points within the same community but
more dissimilar to data of the other community, especially within the
San Diego Data (the four data points at the final time point were more
similar in the Santa Barbara data but seemed to show the same trend to a
lesser degree). Also, the ash leachate community was more dissimilar to
the initial timepoint community than the control community was, which
was again more evident in the San Diego data.
...
A6: At timepoint 0, the control samples showed a significantly greater
richness than the ash leachate, though the shannon index (total
diversity) was not significantly different between control and ash
leachate. At timepoint 6, both richness and diversity were significanly
greater in the control than the ash leachate. Overall, this indicates
that the ash leachate samples were less rich and diverse than the
control (fewer ASVs and fewer dominant ASVs) by timepoint 6.
...
A7: Alteromonadales uniquely increased in relative abundance in ash
leachate but not the control. Oceanospirillales and Campylobacterales
showed the same trend but to a lesser degree. SAR 11 decreased in both,
but far more so in the ash leachate than the control.
...
``` r
saveRDS(sweet.tab, "C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Output_Data/week7/Custom_ASV_Table.rds")
saveRDS(sub_ps, "C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Output_Data/week7/phyloseq_obj.rds")
saveRDS(ps_min, "C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Output_Data/week7/subsampled_phyloseq_obj.rds")
saveRDS(alphadiv, "C:/Users/samro/Desktop/GitHub/Test/144l_students_2021/Output_Data/week7/alphadiv.rds")
```
